...
* They are represented as a list (RecyclerView) on the main screen. This is also my first in action 'Room' database - I tried it once before with the dice app though that didn't really work out back then..
* Edit them.
