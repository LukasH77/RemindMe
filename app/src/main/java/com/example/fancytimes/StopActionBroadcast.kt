...
class StopActionBroadcast : BroadcastReceiver() {
    ...
    override fun onReceive(callingContext: Context?, callingIntent: Intent?) {
        ...
        val notificationTitle = callingIntent.getStringExtra(callingContext.getString(R.string.notification_title_extra_name))
        val notificationText = callingIntent.getStringExtra(callingContext.getString(R.string.notification_text_extra_name))
